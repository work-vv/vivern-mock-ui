...
const Response = ({ responseId }: ResponseProps) => {
  ...
  return (
    <>
      ...
      <form>
        <Select
          selectName="body.type"
          selectValue={body?.type as string}
          selectOptions={ResponseBodyTypes}
          handleSelectChange={handleInputChange}
        />
        <Textarea
          textareaName="body.value"
          textareaValue={body?.value as string}
          textareaPlaceholder="Add template"
